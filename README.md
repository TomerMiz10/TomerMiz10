...
- [**StoicReads**](https://github.com/nitzanto/StoicReads): Developed a full-stack Book rating and sharing app. Implemented API usage, CRUD Operations on User and Post, Jest Unit testing and Google OAuth authentication. **Technologies**: TypeScript, Node.js, Express, MongoDB, React Vite with Material UI.
